import React, { useState, useMemo, useContext, useLayoutEffect, forwardRef, createContext } from "react";
import {
  useFloating,
  autoUpdate,
  offset,
...
export const PopoverContent = forwardRef(function PopoverContent(
  ...
  return (
    <FloatingPortal>
      <FloatingFocusManager context={floatingContext} modal={context.modal} disabled={true}>
        <div
          ref={ref}
